...
$consulta__datos__recorrido = "SELECT *  FROM datos__inicio__recorrido WHERE id_usuario = '{$_SESSION['id_usuario']}'";
$ejecutar__consulta__datos__recorrido = mysqli_query($conexion__db__accent,$consulta__datos__recorrido);
...
<p class="parrafo__historial">En tu historial puedes revisar a detalles tu solicitudes, en esta seccion veras la informacion necesaria de tus servicios de conductor elegido</p>
    ...
    while($resultado__servicios = mysqli_fetch_array($ejecutar__consulta__datos__servicio)){ 
        while($resultado__datos__recorrido = mysqli_fetch_array($ejecutar__consulta__datos__recorrido)){?>

<div class="contenido__historial"data-aos="zoom-in">
<div class="info__perfil datos__de__historial">
        <img src="upload/<?php  echo $resultado__datos__recorrido['avatar'] ?>" alt="" class="foto__de__perfil foto__historial">
    ...
    <div class="info__perfil datos__de__historial">
        ...
        <br><br>
            ...
            <div>
                <p class="datos__basicos"><strong> Nombre : </strong><?php  echo $resultado__datos__recorrido['nombre_conductor'] ?></p>
            </div>
            <div>
                <p class="datos__basicos"><strong>Primer apellido : </strong> <?php  echo $resultado__datos__recorrido['primer_apellido'] ?></p>
            </div>
            <div>
                <p class="datos__basicos"><strong>Segundo apellido : </strong> <?php  echo $resultado__datos__recorrido['segundo_apellido'] ?></p>
            </div>
            <div>
                <p class="datos__basicos"><strong>Documento : </strong> <?php  echo $resultado__datos__recorrido['numero_documento'] ?></p>
            </div>
            <div>
                <p class="datos__basicos"><strong>Telefono :</strong>  <?php  echo $resultado__datos__recorrido['numero_telefono'] ?></p>
            </div>
...
<div class="modal__recorrido" id="modal-recorrido">
 ...
 $consulta__datos = "SELECT *  FROM datos__inicio__recorrido WHERE id_usuario = '{$_SESSION['id_usuario']}'";
...
?>
    ...
    <input type="hidden" value="<?php echo $resultado__datos['id_conductor'] ?>" name="idConductor">
    <input type="hidden" value="<?php echo $datos__resultado['nombre_usuario'] ?>" name="nombreConductor">
    <input type="hidden" value="<?php echo $resultado__datos['avatar_usuario'] ?>" name="avatar">
    <?php } ?>
