...
if($nombre__conductor ==="" || $primer__apellido ==="" || $segundo__apellido ==="" || $email === "" || !is_numeric($documento) || $documento==="" ||!is_numeric($numero__telefono) || $numero__telefono ==="" || $numero__licencia ==="" 
|| !is_numeric($numero__licencia)|| $categoria__licencia ==="" || $contraseña ==="" ){
  ...
  if(mysqli_num_rows($resultado__consulta) > 0){
    ...
    $resultado__insertar = mysqli_query($conexion__db__accent,$insertar__datos);
    if($resultado__insertar){
