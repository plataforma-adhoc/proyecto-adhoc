...
<div class="container contenedor__datos__perfil"> 
    <div class="info__perfil">
        ...
        <a href="./edit-perfil-usuario" class="enlace__editar__perfil">Editar perfil <i class="fas fa-long-arrow-alt-right"></i></a>
        </div>
        <div class="info__perfil">
  ...
  <p class="titulo__opinion">Centro de opiniones</p>
    <div class="opinion__1">
        <div class="item__opinion">
            ...
            <div class="nombre__item__opinion"><p>Nombre</p></div>
        </div>
