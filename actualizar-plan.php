...
if($id__usuario && $id__estilos && $id__contacto && $id__equipamiento && $id__fotos && $id__informacion && $id__seguridad){ ?>
 ...
 <h1 class="subtitulo__planes"> Publica tu vehiculo con el 10% de descuento, solo por tiempo y accede a todos nuestros beneficios <span class="limitado">LIMITADO</span></h1>
  <p class="parrafo__plan__pro">AHORRA EL 10% ACTUALIZANDO TU PLAN AHORA </p>
 <br><br>
   <div class="contenedor__tablas__precio"><?php          
