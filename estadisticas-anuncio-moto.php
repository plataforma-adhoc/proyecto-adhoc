    ...
    <div class="contenido__graficas">
      <div class="myChart">
        <div class="popover">
          ...
          <span class="tooltiptext">Personas que hicieron click y visitaron el perfil del anuncio de la moto</span>
        </div>
        <div  id="grafica"></div>
      </div>
      <div class="myChart">
...
<script>
  ...
  function graficos(id,id__publicacion){
    ...
    fetch(urlServidor+'datos-contador-visitas',{
      method:'post',
      body:form__data
 ...
 function graficos__contacto(id__usuario){
  ...
  let form__data =  new FormData()
    ...
    fetch(urlServidor+'datos-contador-contacto',{
      method:'POST',
      body:form__data
