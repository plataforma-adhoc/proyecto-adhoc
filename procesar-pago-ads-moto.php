...
if($id__usuario && $id__paquete && $idContacto && $idFotos && $idPublicacion){
 $consulta = "SELECT * FROM planes__de__publicaciones__moto WHERE id_paquete = '$id__paquete'";
...
function formasDePago(){
  urlPruebas = 'http://localhost/accent__hollding';
...
var  handler = ePayco.checkout.configure({
        ...
        var data={
          ...
          external:"false",
          response:"https://adhoc.com.co/estado-pago-ads-moto?idp=<?php echo $id__paquete ?>&idu=<?php echo $id__usuario ?>&idc=<?php echo $idContacto ?>&idf=<?php echo $idFotos ?>&idp=<?php echo $idPublicacion ?>",
