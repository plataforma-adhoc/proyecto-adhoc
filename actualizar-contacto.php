...
$whatsapp__2  = isset($_POST['whatsapp_2']) ? $_POST['whatsapp_2']: '';
$telefono__1 = isset($_POST['telefono_1']) ? $_POST['telefono_1']: '';
$telefono__2  = isset($_POST['telefono_2']) ? $_POST['telefono_2']: '';

$actaulizar__datos__contacto = "UPDATE contacto__vendedor SET whatsapp_1 = '$whatsapp__1',whatsapp_2 = '$whatsapp__2',telefono_1 = '$telefono__1',telefono_2 = '$telefono__2'
