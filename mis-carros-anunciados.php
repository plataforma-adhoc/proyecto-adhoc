...
<br><br>
    ...
    <p class="subtitulo__anuncio__carro">Administra y edita la informacion de tus vehiculos anunciados</p>
  ...
  <thead>
    ...
    <th scope="col">Id  de la publicación</th>
      ...
      <th scope="col">Precio del vehiculo</th>
  ...
  <tbody>
    <tr>
      ...
      if($fila__resultado['estado_anuncio'] ==='1'){
       ...
       <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal2" class="btn__desactivar__anuncio" data-bs-id="<?php  echo $fila__resultado['id_publicacion_vehiculo']  ?>">Pausar</a>
     <?php } 
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Estas seguro de eliminar esta información ? </h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
let eliminar =  document.getElementById('exampleModal');
...
boton__Eliminar.value = id
 ...
 function eliminarDatos(usuario){
  ...
  fetch(url__servidor+'eliminar-perfil-vehiculo',{
  method:'POST',
  body:form__data,
  mode:'cors'
  }).then(respuesta => respuesta.json())
