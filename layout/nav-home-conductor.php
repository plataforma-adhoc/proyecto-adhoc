...
<body>
      ...
      <div class="container nav__container">
        ...
        <div class="enlaces__varios">
          ...
          <div class="containers">
            <label class="btn btn-open" for="nav" id="abrir-menu-dashboard"><i class="fab fa-creative-commons-nd"></i></label>
            <input type="checkbox" id="nav" class="nav-opener" />
            <div class="nav" id="menu-dashboard">
              <div class="nav-header headers__dashobard">
              <label class="btn__cerrar__menu btn-nav" for="nav">
                <svg style="width: 36px;" viewBox="0 0 24 24">
  ...
  <script>
    function cerrar__menu__dasboard(){
