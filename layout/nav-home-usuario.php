    ...
    <nav class="nav__hero">
      <div class="container nav__container">
        ...
        <div class="enlaces__varios">
          <div>
            <a href="#" class="enlace__notificaciones" data-bs-toggle="modal" data-bs-target="#modal-notificaciones"><i
                class="fas fa-bell"></i>
          ...
          <div class="containers">
            <label class="btn btn-open" for="nav" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling"
