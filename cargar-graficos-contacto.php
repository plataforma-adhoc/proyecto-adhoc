<?php
function obtener__graficos__contacto(){
    include'conexion-db-accent.php';
    $id__usuario = isset($_POST['id']) ? $_POST['id']: '';
    if($id__usuario){
        $array = array();
        $selecionar__datos__graficos = "SELECT * FROM contador__de__clicks__contacto WHERE id_usuario = '$id__usuario'";
