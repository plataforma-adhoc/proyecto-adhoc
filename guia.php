<?php
$titulo =  "Guia para vender mi vehiculo| AdHoc";
include'layout/nabvar.php'; ?>
<div class="container">
<div class="contenedor__asesoramiento" id="asesoramiento">
  <h1 class="subtitulo__asesoramiento">Como vender mi carro o moto, rapido</h1>
  <p class="texto__asesoramiento">Si estás buscando vender tu carro o moto  rápidamente, hay algunas cosas que puedes hacer para aumentar tus posibilidades de éxito. Aquí te presento algunos consejos útiles para vender tu vehículo rápidamente</p>
<div class="contenido__asesoramiento">
  <div class="asesoramiento">
    ...
    <div class="descripcion__asesoramiento">
      ...
      <p class="parrafo__asesoramiento">Busca un lugar bien iluminado y sin sombras para tomar las fotos. Si es posible, toma las fotos al aire libre, preferiblemente en un día soleado, para que la luz natural ilumine el vehiculo de manera uniforme.
...
<p class="parrafo__asesoramiento">Realiza un mantenimiento general al carro o moto usada, como cambio de frenos, ajuste de la suspensión, revisión del sistema eléctrico, entre otros. Esto puede ayudar a que  funcione mejor y aumentar su valor de reventa.
Lava y detalla  para que luzca bien tanto por fuera como por dentro. Un vehículo limpio y bien cuidado puede hacer una gran diferencia en el precio de venta.
</p>
    </div>
  </div>
  <div class="asesoramiento  borde__derecho">
    ...
    <div class="descripcion__asesoramiento">
      ...
      <p class="parrafo__asesoramiento">
        Si tienes un historial de mantenimiento detallado, inclúyelo en el anuncio en l aparte de la descripción. Esto puede ayudar a los posibles compradores a sentirse más seguros de la calidad.
        Describe el estado actual  y si ha tenido algún tipo de mantenimiento o reparaciones recientes. Es importante que los posibles compradores sepan que el carro o moto está en buenas condiciones.
      </p>
    </div>
  </div>
  <div class="asesoramiento  borde__derecho">
...
<p class="parrafo__asesoramiento">Proporciona una descripción detallada del estado actual del vehiculo. Si hay rasguños, abolladuras, partes rotas o defectos, mencionarlos en el anuncio. De esta forma, los posibles compradores sabrán qué esperar antes de ver el carro o la moto usada en persona.
Establece un precio justo. Investiga los precios de mercado moto o carros  similares para tener una idea de cuál es un precio justo.
</p>
   </div>
  </div>
</div>
...
<br>
<div class="contenido__de__la__guia">
<h2 class="subtitulo__asesoramiento">Guia de como vender</h2>
<p class="texto__asesoramiento">Aquí te presento una guía útil de cómo vender:</p>
...
<div class="guia">
  <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="enlace__guia">
    ...
    <i class="fas fa-car preparando__el__carro"></i>
      <h3>Preparando tu carro o moto </h3>
  ...
  <div class="modal-dialog modal-dialog-centered modal-fullscreen">
    <div class="modal-content">
      ...
      <div class="modal-body cuerpo__modal">
        <h2 class="subtitulo__modal__body">Preparando  para vender</h2>
        <br><br>
...
CONSEJOS
<br>
Limpiar el carro por dentro y por fuera. Asegúrate de que todo funcione. Reúne todos los papeles del vehículo.
<br><br>
Limpiando tu auto
<br><br>
