<?php
$titulo = 'Adhoc | Marcas de carros electricos';
include'nabvar.php';?>
...
<h1 class="titulo__como__vender__un__carro">Marcas de carros electricos</h1>
...
<p class="texto__del__blog">
  ...
  forma parte del movimiento de codigo abierto, esto significa que cualquier avance que tenga la empresa estara disponible para sus competidores. <br><br>
  su modelo insignia : <strong>Model S</strong><br>
  precio medio : <strong>95.000 Euros</strong><br>
  Autonomia : <strong>595 Kilómetros</strong><br>

  <h3 class="subtitulo__h3__blog">2. BMW</h3>
  <div class="vehiculos__electricos">
    <img src="../img/carro__electrico__BMW.webp" alt="carro Tesla electrico">
</div>
  <p class="texto__del__blog">
    BMW i es una filial de BMW  que fue fundada en 2011 para el desarrollo de la series i3 e i8 el cual se ha convertido en el tercer vehiculo totalmente electrico
    más vendido en el mundo. 
    A partir de 2016, BMW ha lanzado cuatro modelos. Tambien ha sido fabricado en 85% de materiales reciclabes,<br><br>
    su modelo insignia : <strong>BMW i3</strong>
  precio medio : <strong>40.000 Euros</strong><br>
  Autonomia : <strong>310 Kilómetros</strong><br>
</p>
<h3 class="subtitulo__h3__blog">3. NIssan</h3>
  <div class="vehiculos__electricos">
    <img src="../img/carro__electrico__nissan.webp" alt="carro nissan electrico">
</div>
<p class="texto__del__blog">
Nissan se ha coronado como el primer fabricante de vehiculos eléctricos que lanzo el primer carro electrico totalmente en masa y dirigido 
a familias mucho más responsables con el medio ambiente. El nissan Leafe su modelo insignia ha utlizado todos los sistemas de los modelos tradicionales
el nissan Leaf ha sido uno de los vehiculos electricos más vendidos en todo el mundo hasta hace poco tiempo con ventas historicas que alcanzaron 
un record de  <strong>87 mil unidades</strong>
<br><br>
    su modelo insignia : <strong>Nissan Leaf</strong><br>
  precio medio : <strong>Desde 32.000 Euros</strong><br>
  Autonomia : <strong>270 Kilómetros</strong><br>
</p>
<h3 class="subtitulo__h3__blog">4. Wolkswagen</h3>
  <div class="vehiculos__electricos">
    <img src="../img/carro__electrico__Wolkswagen.webp" alt="carro Wolkswagen electrico">
</div>
<p class="texto__del__blog">
 Wolkswagen ha sido elogiada como una de las marcas de carro electricos de nivel de entrda fuerte gracias a su diseño y utilidad que se ha basado
 en modelos de vehiculos más tradicionales, eso lo convierte en un peqieño salto para pasar a nuevos modelos según la revista Carmagazine.
 Por supuesto sera muy esencial para que los carros electricos tengan un impacto en las proximas generaciones. 
<br><br>
    su modelo insignia : <strong>E-Golf</strong><br>
  precio medio : <strong>Desde 30.000 Euros</strong><br>
  Autonomia : <strong>120 Kilómetros</strong><br>
</p>
<h3 class="subtitulo__h3__blog">4. Kia</h3>
  <div class="vehiculos__electricos">
    <img src="../img/carro__electrico__kia.webp" alt="carro kia electrico">
</div>
<p class="texto__del__blog">
Kia  fue fundada en 1944 en con sede en Seul y fue comprada por Hyundai en 1998 cuando se hizo del control de la compañia  cuando se hizo acreedor
del  51% de participacion de la empresa, sin embargo Hyundai Motor Co posee una paricipación del 33,88%  con una valoracion de más 
<strong>5.400 Millones </strong> de euros. <br>
La movilidad electrica de la compañia suministra vehiculo adsequibles pero robustos a una escala global.
 
<br><br>
    su modelo insignia : <strong>Kia Soul EV</strong><br>
