...
while($fila = mysqli_fetch_array($ejecutar__consulta)){ 
    ...
    <div class="conetendor__imagen__vehiculo">
        <img src="'.$fila['foto_1'] .'" alt="" class="imagen__del__vehiculo">
...
<div class="datos__del__vehiculo">
  ...
  <div>
  <a href="https://api.whatsapp.com/send?phone=numero'. $fila['whatsapp_1'].'&text=mensaje=Hola vi el anuncio de tu vehiculo an AdHoc" class="enlace__whatsapp"><i class="fab fa-whatsapp"></i> Habla con el vendedor</a>
   </div>
   <div>
