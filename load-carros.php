...
while($fila = mysqli_fetch_array($ejecutar__consulta)){
 ...
 $fila__contactos = mysqli_fetch_array($ejecutar__consulta__contacto);
    ...
    <div class="conetendor__imagen__vehiculo">
         <img src="'. isset($fila__fotos['foto_1']).'" alt="Foto portada del carro usado en venta" class="imagen__del__vehiculo">
...
<div class="datos__del__vehiculo">
  ...
  <div>
  <a href="https://api.whatsapp.com/send?phone=numero'. isset($fila__contactos['whatsapp_1']).'&text=mensaje=Hola vi el anuncio de tu vehiculo en AdHoc" class="enlace__whatsapp"><i class="fab fa-whatsapp" target="_blank"></i> Habla con el vendedor</a>
   </div>
