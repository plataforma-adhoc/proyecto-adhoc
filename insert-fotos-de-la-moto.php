...
session_start();
  if(!is_dir('upload')){
    ...
    foreach($_FILES['file']['tmp_name'] as $key => $value){
     ...
     if($idUsuario==="" || $ruta__1==="" || $ruta__2==="" || $ruta__3==="" || $ruta__4==="" || $ruta__5==="" || $ruta__6==="" || $ruta__7==="" ||
     $ruta__8==="" || $ruta__9==="" || $ruta__10===""){
       echo json_encode('error');
     }else{
         $fotosDeLaMoto = array(
         'id'=>$idUsuario,'ruta_1'=>$ruta__1,'ruta_2'=>$ruta__2,'ruta_3'=>$ruta__3,'ruta_4'=>$ruta__4,'ruta_5'=>$ruta__5,'ruta_6'=>$ruta__6,
         'ruta_7'=>$ruta__7,'ruta_8'=>$ruta__8,'ruta_9'=>$ruta__9,'ruta_10'=>$ruta__10);
         
         $fotos = $_SESSION['fotosDeLaMoto'] = $fotosDeLaMoto;
         if($fotos){
             echo json_encode('ok');
